...
import { ArrowSquareOutIcon, ChatCenteredTextIcon, StarIcon, TrayIcon } from "@phosphor-icons/react/dist/ssr";
              ...
              >
                {[...Array(5)].map((_, i) => (
                  <StarIcon
                    key={i}
                    size={16}
                    weight={i < comment.rating ? "fill" : "regular"}
                    color={i < comment.rating ? "#fbbf24" : "#94a3b8"}
                  />
                ))}
